...
{  
    ...
    try
    {
        ...
        cout << "Face directory is created" << endl;
        ...
        cout << "upsampling first dataset" << endl;
        upsample_image_dataset<pyramid_down<2> >(images_test,  face_boxes_test);
        cout << "upsampling second dataset" << endl;
