...
/*
 ...
 ./face_detection_ex faces/*.png //edit: changed file types to .png
 
 //Edit 1:
 The program will have a prewritten array of image file paths that will serve as 
 the test images instead of looping through a directory.
 //edit 2:
...
int main(int argc, char** argv)
{
    try
    {
        ...
        for (int i = 1; i < argc; i++)
        {
            ...
            array2d<char> img;
            cout << "array2d<unsigned char> img; " << argv[i] << endl;
            load_image(img, argv[i]);
            cout << "load_image(img, argv[i]); " << argv[i] << endl;
            ...
            pyramid_up(img);
            cout << "pyramid_up(img); " << argv[i] << endl;
            
            
            // Now tell the face detector to give us a list of bounding boxes
            // around all the faces it can find in the image.
            std::vector<rectangle> dets = detector(img);
            cout << "std::vector<rectangle> dets = detector(img); " << argv[i] << endl;
