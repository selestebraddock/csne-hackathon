...
#include "walk_dude_detector_abstract.h"
...
namespace dlib
{
    typedef object_detector<scan_fhog_pyramid<pyramid_down<6> > > walk_dude_detector;
    inline const std::string get_serialized_frontal_faces();

    inline walk_dude_detector get_walk_dude_detector()
    {
        std::istringstream sin(get_serialized_walk_dudes());
        walk_dude_detector detector;
...
// ----------------------------------------------------------------------------------------
    ...
    /*
        ...
        The front detector:
            trained on mirrored set of labeled_faces_in_the_wild/walk_dudes.xml
        ...
        The front-rotate-right detector:
            ...
            singular value threshold: 0.15
    */
    inline const std::string get_serialized_walk_dudes()
    {
